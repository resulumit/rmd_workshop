...
<sup>*</sup> Some settings become available on the document toolbar as well, only when an .Rmd document is open. We will cover the [document toolbar](#toolbar) later on in the workshop.
...
- R for Data Science ([Wickham and Grolemund, 2021](https://r4ds.had.co.nz](https://r4ds.had.co.nz/))
