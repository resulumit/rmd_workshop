...
Unless otherwise noted, all content is copyright Resul Umit, licensed [CC-BY-SA 3.0](https://github.com/resulumit/rmd_workshop/LICENCE.md). An easy to read summary of this permissive licence is available on the [Creative Commons website)(https://creativecommons.org/licenses/by-sa/3.0/).
